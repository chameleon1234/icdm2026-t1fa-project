# ADNI Fair Downstream Evaluation Report

Protocol: subject-level train/test using `data/adni_processed/adni_slice_manifest.csv`; methods include T1_ONLY, FA_GT, Old Fidelity Flow, A080 Base, A080+DS Full, UNet, Pix2Pix, CycleGAN, and LightGuard PriorFlow.
