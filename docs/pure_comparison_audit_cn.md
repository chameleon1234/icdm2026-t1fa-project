...
- `CycleGAN_E100`: 旧 CycleGAN，等 `CycleGAN_CurrentSplit_E100` 完成后替换。
...
| `CycleGAN_CurrentSplit_E100` | GAN | 正在公平重训 |
...
1. 等 `CycleGAN_CurrentSplit_E100` 完成后，导出、评估、下游，再替换旧 `CycleGAN_E100`。
