# Final Dual-Dataset Downstream Audit and Closure Report

## Conclusion

- ADNI ConclusionConclusion? `ADNI_A080_DS_CORRECTOR_DISEASEROI_HFPRESERVE_FULL_E12_SCOREBEST` ConclusionConclusion? subject-level train/test ConclusionConclusion?
- ADNI ConclusionConclusionConclusion?T1_ONLY?FA_GT?Old Fidelity Flow?A080 Base?A080+DS Full?UNet?Pix2Pix?CycleGAN?LightGuard PriorFlow?
- ConclusionConclusionConclusionConclusionConclusionT1_ONLY?FA_GT?FidelityFlow?PRIVATE_DS_HYBRID?UNet?Pix2Pix?CycleGAN?
- Final Dual-Dataset Downstream Audit and Closure Report?ADNI ? A080+DS Full Conclusion? Macro-AUC ConclusionConclusionConclusion? T1_ONLY Conclusion? Macro-AUC Conclusion?FidelityFlow ? Accuracy Conclusion?
- ConclusionConclusionConclusionConclusion?A080+DS Full Final Dual-Dataset Downstream Audit and Closure ReportFinal Dual-Dataset Downstream Audit and Closure ReportFinal Dual-Dataset Downstream Audit and Closure ReportConclusionConclusionConclusion

## ADNI ConclusionConclusionConclusionConclusion
...
- ADNI DDIM / DBM / MOTFM ConclusionConclusion test Conclusion? checkpoint ConclusionConclusion? train-full prediction folderConclusionConclusionConclusionConclusion? train/test ConclusionConclusion?
- Conclusion? `PRIVATE_STAGE1_SINGLE_SHARP_STRIPE_EPOCH030` ? `Stage1_LPIPS_GAN` Conclusion train-full prediction folderConclusionConclusionConclusionConclusion? train/test ConclusionConclusion?
